...
function options() { //de options pagina 
    ...
    description.innerHTML = "Hier kan je alle speciale opties voor de game veranderen, zoals het aantal seconden waarop de game timer word gezet.";
    ...
    create_element("INPUT", "check_timer", "checkbox", "");
    check_timer_element = document.getElementById('check_timer');
    check_timer_element.checked = true;

    create_span("game timer", "span1", "check_timer");
    span1 = document.getElementById('span1');

    check_timer = document.getElementById("check_timer").checked;
